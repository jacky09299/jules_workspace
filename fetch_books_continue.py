...
# Get current count
try:
    with open("civilization_library.md", "r") as f:
        STARTING_COUNT = sum(1 for line in f)
...
print(f"Starting at count: {STARTING_COUNT}, need {BOOKS_NEEDED} more books.")
...
SUBJECTS = [
    ...
    "paleontology", "astrophysics", "bioinformatics", "robotics", "nanotechnology"
]
...
def fetch_books():
    ...
    with open(OUTPUT_FILE, "a") as f:
        ...
        for subject in SUBJECTS:
            ...
            # We fetch up to 1000 items per subject to ensure we hit our target
            offset = 0
            limit = 100
                ...
                try:
                    ...
                    for work in works:
                        ...
                        if books_added % 1000 == 0:
                            print(f"Progress: Added {books_added} books so far... total is {STARTING_COUNT + books_added}")
